...
export const SPATIAL_REVIEW_CONNECTION_REJECTED = "spatial-review:connection-rejected" as const;
export const SPATIAL_REVIEW_EDITOR_ORIGIN_NOT_AUTHORIZED = "editor-origin-not-authorized" as const;
