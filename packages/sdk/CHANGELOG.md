...
- 08d899b: Add explicit asynchronous Three.js texture hydration that preserves supported material maps and sampler transforms without implicitly fetching untrusted URLs.
